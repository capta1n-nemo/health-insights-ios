// ⚠️ **THIS FILE IS IN NO TARGET, AND THAT IS DELIBERATE. IT DOES NOT COMPILE
// IN CI.** Read `docs/widgets.md` before switching it on.
//
// Backlog `D8`. Enabling the widget extension turns a deploy *install* failure
// into a deploy *build* failure, and `main` is the only route to this reader's
// phone — the exact reasoning that parked `ShotsyImportAction` on 2026-08-02
...
@main
struct HealthInsightsWidgets: WidgetBundle {
