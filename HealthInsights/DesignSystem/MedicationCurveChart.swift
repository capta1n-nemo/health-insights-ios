...
struct MedicationCurveChart: View {
    ...
    private var measured: [ActiveCompoundPoint] { points.filter { !$0.restsOnInferredDose } }
    private var estimated: [ActiveCompoundPoint] { points.filter(\.restsOnInferredDose) }
